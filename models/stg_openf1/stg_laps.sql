...
WITH base AS (
    SELECT
        ...
        try_to_decimal(duration_sector_1::varchar, 9, 3) as s1_s,
        try_to_decimal(duration_sector_2::varchar, 9, 3) as s2_s,
        try_to_decimal(duration_sector_3::varchar, 9, 3) as s3_s,
        try_to_decimal(lap_duration::varchar,        9, 3) as lap_time_s_raw,
